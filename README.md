...
2. Extract the zip
3. Run main.exe in zip (if you get no dll found dw you can still run it, only it will be slower (idk why kek))
...
8. https://stackoverflow.com/questions/4755303/python-cdll-cant-find-module
